...
- (void)viewDidLoad {
  [super viewDidLoad];
  self.tagsView.constantHeight = YES;
  self.tagsView.displayMoreTagsCount = YES;
...
//	NSString *text = @"Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.";
